...
- **Successful**: 15
- **Failed**: 0
- **Total Execution Time**: 1084.7 seconds (18.08 minutes)

### Runtime Statistics (per run)

- **Average**: 72.3 seconds
- **Minimum**: 66.4 seconds
- **Maximum**: 77.9 seconds

### Population Statistics (averages across successful runs)

- **Average Final Generation/Cycle**: 303
- **Average Final Population Size**: 82 creatures
- **Average Total Creatures Created**: 5,809 creatures
...
python ../analytics/comprehensive_analytics.py simulation_run_001_seed_9000.db

# Chart phenotype frequencies across generations
python ../analytics/chart_phenotype.py simulation_run_001_seed_9000.db

# Analyze genotype frequencies
python ../analytics/analyze_genotype_frequencies.py simulation_run_001_seed_9000.db
```
