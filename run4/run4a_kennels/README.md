...
- **Successful**: 15
- **Failed**: 0
- **Total Execution Time**: 1165.5 seconds (19.43 minutes)

### Runtime Statistics (per run)

- **Average**: 77.7 seconds
- **Minimum**: 71.3 seconds
- **Maximum**: 84.0 seconds

### Population Statistics (averages across successful runs)

- **Average Final Generation/Cycle**: 303
- **Average Final Population Size**: 24 creatures
- **Average Total Creatures Created**: 6,307 creatures
...
python ../analytics/comprehensive_analytics.py simulation_run_001_seed_5000.db

# Chart phenotype frequencies across generations
python ../analytics/chart_phenotype.py simulation_run_001_seed_5000.db

# Analyze genotype frequencies
python ../analytics/analyze_genotype_frequencies.py simulation_run_001_seed_5000.db
```
