#!/usr/bin/env python
"""
Run 4 Execution Script - Kennel vs Mill Breeding Comparison (Extended Timeframe)
...
Configuration:
- 200 creatures, 20 years (extended from run3's 6 years)
...
def main():
    """Execute both batches for Run 4."""
    config_path = "run4_config.yaml"
    ...
    print("\n" + "="*80)
    print("RUN 4: KENNEL VS MILL BREEDING COMPARISON (EXTENDED TIMEFRAME)")
    print("="*80)
    ...
    print("(Extended from Run 3's 6 years to observe long-term trait dynamics)")
    ...
    print("\nResults:")
    print("  - Batch A (Kennel-dominated): run4a_kennels/")
    print("  - Batch B (Mill-dominated):   run4b_mills/")
    print("\nNext steps:")
    print("  1. Analyze individual batches:")
    print("     cd ..")
    print("     python batch_analysis.py run4/run4a_kennels")
    print("     python batch_analysis.py run4/run4b_mills")
