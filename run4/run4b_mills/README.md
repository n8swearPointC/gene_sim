...
- **Successful**: 15
- **Failed**: 0
- **Total Execution Time**: 494.0 seconds (8.23 minutes)

### Runtime Statistics (per run)

- **Average**: 32.9 seconds
- **Minimum**: 27.1 seconds
- **Maximum**: 43.6 seconds

### Population Statistics (averages across successful runs)

- **Average Final Generation/Cycle**: 303
- **Average Final Population Size**: 0 creatures
- **Average Total Creatures Created**: 1,205 creatures
...
python ../analytics/comprehensive_analytics.py simulation_run_001_seed_6000.db

# Chart phenotype frequencies across generations
python ../analytics/chart_phenotype.py simulation_run_001_seed_6000.db

# Analyze genotype frequencies
python ../analytics/analyze_genotype_frequencies.py simulation_run_001_seed_6000.db
```
