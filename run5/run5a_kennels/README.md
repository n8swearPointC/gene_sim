...
**Generated**: 2025-11-13 22:43:50

## Configuration

- **Initial Population Size**: 200 creatures
- **Simulation Duration**: 6 years
- **Number of Runs**: 15
- **Base Seed**: 7000
- **Seed Range**: 7000 to 7014

### Breeder Distribution

- Kennel Club Breeders: 19
- Mill Breeders: 1
- Random Breeders: 0
...
- **Successful**: 15
- **Failed**: 0
- **Total Execution Time**: 329.2 seconds (5.49 minutes)

### Runtime Statistics (per run)

- **Average**: 21.9 seconds
- **Minimum**: 20.2 seconds
- **Maximum**: 25.5 seconds

### Population Statistics (averages across successful runs)

- **Average Final Generation/Cycle**: 90
- **Average Final Population Size**: 120 creatures
- **Average Total Creatures Created**: 2,211 creatures
...
python ../analytics/comprehensive_analytics.py simulation_run_001_seed_7000.db

# Chart phenotype frequencies across generations
python ../analytics/chart_phenotype.py simulation_run_001_seed_7000.db

# Analyze genotype frequencies
python ../analytics/analyze_genotype_frequencies.py simulation_run_001_seed_7000.db
```
