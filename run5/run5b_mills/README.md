...
- **Successful**: 15
- **Failed**: 0
- **Total Execution Time**: 205.4 seconds (3.42 minutes)

### Runtime Statistics (per run)

- **Average**: 13.7 seconds
- **Minimum**: 9.9 seconds
- **Maximum**: 17.6 seconds

### Population Statistics (averages across successful runs)

- **Average Final Generation/Cycle**: 90
- **Average Final Population Size**: 15 creatures
- **Average Total Creatures Created**: 961 creatures
...
python ../analytics/comprehensive_analytics.py simulation_run_001_seed_8000.db

# Chart phenotype frequencies across generations
python ../analytics/chart_phenotype.py simulation_run_001_seed_8000.db

# Analyze genotype frequencies
python ../analytics/analyze_genotype_frequencies.py simulation_run_001_seed_8000.db
```
