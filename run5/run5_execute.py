#!/usr/bin/env python
"""
Run 5 Execution Script - Kennel vs Mill Breeding Comparison
...
def main():
    """Execute both batches for Run 5."""
    config_path = "run5_config.yaml"
    ...
    print("\n" + "="*80)
    print("RUN 5: KENNEL VS MILL BREEDING COMPARISON")
    print("="*80)
    print("\nThis will execute 30 total simulations (2 batches of 15 runs each)")
    print("Configuration: 200 creatures, 6 years, 20 total breeders")
    ...
    print("\nResults:")
    print("  - Batch A (Kennel-dominated): run5a_kennels/")
    print("  - Batch B (Mill-dominated):   run5b_mills/")
    print("\nNext steps:")
    print("  1. Analyze individual batches:")
    print("     cd ..")
    print("     python batch_analysis.py run5/run5a_kennels")
    print("     python batch_analysis.py run5/run5b_mills")
